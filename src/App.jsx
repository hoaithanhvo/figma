    ...
    <div className={styles.container}>
      ...
      <div className={styles.navbar}>
        ...
        <div className={styles.menu}>
          <img style={{ width: "24px", height: "24px" }} src={menu} ></img>
        </div>
      </div>
      ...
      <div className={styles.companies}>
        ...
        <div className={styles.logos}>
          <div className={styles.company_logo}>
            ...
            <div className={styles.puzzle} style={{ display: "flex", justifyContent: "space-evenly", height: "34px", alignItems: "center" }}>
              <div className={styles.puzzle_item} style={{ position: "relative", textAlign: "center", }}>
              ...
              <img className={styles.slack} src={slack}></img></div>
            <div style={{ display: "flex" }}>
              <img className={styles.dropbox} style={{ marginRight: "5px" }} src={dropbox}></img>
      ...
      <div className={styles.test}>
        ...
        <div className={styles.testimonial}>
          <div className={styles.name_item}>
            ...
            <p className={styles.title}>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc ullamcorper scelerisque mi, in malesuada felis malesuada vel. </p>
          </div>
          <div className={styles.name_item}>
      ...
      <div className={styles.contact}>
        ...
        <div className={styles.box}>
          ...
          <p className={styles.text1}>We work with Brans, Startups, to SMEs. Colaborate for more impact and growt
          </p>
          <button className={styles.button}>CONTACT US</button>
        </div>
      </div>
